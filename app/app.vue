    ...
    <nav class="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
        <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
            <a href="#" class="flex items-center">
                <img src="/images/ImagenDataGlobal-01.jpg" class="mr-3 h-6 sm:h-9" alt="Flowbite Logo" />
            </a>
            ...
            <div class="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-11 lg:mt-0">
                    <li>
                    ...
                    <li>
                        <a href="#" class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">Lo que hacemos</a>
                    </li>
                    <li>
                        <a href="#" class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">Pagos</a>
                    </li>
                    <li>
...
<section class="bg-[url('https://flowbite.s3.amazonaws.com/blocks/marketing-ui/hero/coast-house-view.jpg')] bg-no-repeat bg-cover bg-center bg-gray-700 bg-blend-multiply ">
    <div class="relative py-8 px-4 mx-auto max-w-screen-xl text-white lg:py-16 z-1">
        <div class="mb-6 max-w-screen-lg lg:mb-0">
            <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl lg:text-6xl">Impulsamos tu Potencial Digital</h1>
            <p class="mb-6 font-light text-gray-400 lg:mb-8 md:text-lg lg:text-xl">Somos tu socio estratégico en desarrollo de software, especializados en crear páginas web, aplicaciones y soluciones digitales a medida que impulsan tu negocio hacia el éxito</p>
        ...
        <div class="grid gap-8 pt-8 lg:pt-12 mt-8 lg:mt-12 border-t border-gray-600 sm:grid-cols-2 lg:grid-cols-4">
            <div>
                <h2 class="mb-1 text-lg font-bold">Desarrollo Web Personalizado</h2>
                <p class="mb-1 text-sm text-gray-400">Desde sitios informativos hasta e-commerce robustos, creamos páginas web únicas y escalables para tu negocio.</p>
                <a href="#" class="inline-flex items-center text-sm font-semibold text-primary-500 hover:underline">
                   Explora el Desarrollo Web 
            ...
            <div>
                <h2 class="mb-1 text-lg font-bold">Resultados Comprobados</h2>
                <p class="mb-1 text-sm text-gray-400">Nuestro portafolio de proyectos exitosos habla por sí mismo. Clientes satisfechos y objetivos alcanzados.</p>
                <a href="#" class="inline-flex items-center text-sm font-semibold text-primary-500 hover:underline">
                    Ver Casos de Éxito 
                    <svg class="ml-1 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                </a>
            ...
            <div>
                <h2 class="mb-1 text-lg font-bold">Rendimiento y Optimización Garantizada</h2>
                <p class="mb-1 text-sm text-gray-400">Construimos software que no solo funciona, sino que lo hace de manera rápida y eficiente, sin comprometer el rendimiento </p>
                <a href="#" class="inline-flex items-center text-sm font-semibold text-primary-500 hover:underline">
                    Contactanos
                    <svg class="ml-1 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                </a>
            ...
            <div>
                <h2 class="mb-1 text-lg font-bold">Equipos Multidisciplinarios Expertos</h2>
                <p class="mb-1 text-sm text-gray-400">Contamos con talentos especializados en desarrollo, diseño y estrategia para tu proyecto integral</p>
                <a href="#" class="inline-flex items-center text-sm font-semibold text-primary-500 hover:underline">
                    Conoce al equipo
                    <svg class="ml-1 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                </a>
